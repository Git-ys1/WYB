...
static const freq_profile_cfg_t k_freq_profile_cfg[BSP_FREQ_PROFILE_COUNT] = {
    [BSP_FREQ_PROFILE_20HZ] = {.ic_prescaler = TIM_ICPSC_DIV1, .ic_filter = 8u, .no_sig_timeout_ms = 600u, .accum_cycles = 4u},
    [BSP_FREQ_PROFILE_200HZ] = {.ic_prescaler = TIM_ICPSC_DIV1, .ic_filter = 4u, .no_sig_timeout_ms = 300u, .accum_cycles = 2u},
    ...
    [BSP_FREQ_PROFILE_200KHZ] = {.ic_prescaler = TIM_ICPSC_DIV2, .ic_filter = 0u, .no_sig_timeout_ms = 30u, .accum_cycles = 1u}
};
